...
IPTU.lotes %>% 
  ...
  summarize(pavimentos = weighted.mean(pavimentos, area_construida)) %>% 
...
remove(favela, gg, lotes_irregulares, censo, IPTU.lotes)
```
...
lm(densidade ~ unidades, data = df) %>% summary()
