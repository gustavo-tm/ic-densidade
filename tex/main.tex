...
\autor{Gustavo Theil}
\titulo{Para o bem ou para o mal: análise da capacidade que o governo tem de controlar a densidade habitacional}
\instituicao{
  %
...
O Plano Diretor Estratégico (PDE 2014) do município de São Paulo tem como um dos principais objetivos gerar adensamento populacional nas áreas mais desejáveis. Para tanto, foram criados instrumentos regulatórios e incentivos de determinados padrões construtivos, com a expectativa de que estes sejam capazes de gerar maior densidade populacional nessas determinadas regiões. O escopo desta pesquisa é identificar se estes padrões construtivos incentivados e regulamentados são de fato capazes de definir a densidade da região. As estimativas apontam que cerca de metade da cidade não responde aos incentivos ou às leis, já que não está registrada no Cadastro Imobiliário Fiscal e portanto se encontra em situação informal. Para a outra metade, identificou-se que entre os padrões construtivos, a densidade habitacional se demonstrou a mais efetiva para definir a densidade populacional, seguida pela densidade construtivas. Há fracas evidências que apontam para a relevância do número de pavimentos. 
...
The Strategic Master Plan (PDE 2014) of the city of São Paulo has, as one of its main objectives, to generate population densification in the most desirable areas. To achieve this, regulatory instruments and incentives for certain construction standards were created, with the expectation that these would be able to generate higher population density in these specific regions. The scope of this research is to identify whether these incentivized and regulated construction standards are indeed capable of determining the density of the region. Estimates indicate that about half of the city does not respond to the incentives or laws, as it is not registered in the Fiscal Property Registry and therefore exists in an informal status. For the other half, it was identified that among the construction standards, residential density proved to be the most effective in determining population density, followed by construction density. There is weak evidence pointing to the relevance of the number of floors.
